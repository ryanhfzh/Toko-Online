        ...
        <div class="container">
          <div class="row align-items-center">
            ...
            <div class="col-12 mb-3 mb-md-0 col-md-4 order-1 order-md-2 text-center">
              <div class="site-logo">
                <a href="<?php echo e(route('home')); ?>" class="js-logo-clone">RideLabel</a>
              </div>
            </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-6 mb-5 mb-lg-0">
            <div class="row">
              <div class="col-md-12">
                <h3 class="footer-heading mb-4">Ride Label</h3>
              </div>
              <div class="col-md-6 col-lg-4">
                <ul class="list-unstyled">
                  ...
                  <li><a href="#">Ride Label Care</a></li>
                </ul>
              </div>
              <div class="col-md-6 col-lg-4">
                <ul class="list-unstyled">
                  ...
                  <li><a href="#">Kurir Ekspedisi</a></li>
                </ul>
              </div>
              <div class="col-md-6 col-lg-4">
                <ul class="list-unstyled">
          ...
          <div class="col-md-6 col-lg-6">
            <div class="block-5 mb-5">
              ...
              <ul class="list-unstyled">
                ...
                <li class="phone"><a href="tel://23923929210">+62 1234 5678 910</a></li>
                <li class="email">ridelabel@gmail.com</li>
              </ul>
            </div>
...
<?php /**PATH C:\xampp\htdocs\tokoOnline\resources\views/user/app.blade.php ENDPATH**/ ?>