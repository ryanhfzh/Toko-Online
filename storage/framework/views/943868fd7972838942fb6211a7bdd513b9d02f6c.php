...
<div class="site-section">
    ...
    <div class="col-md-12 text-center">
        <h3 class="display-5" style="text-transform:uppercase">Hasil Pencarian Untuk : <?php echo e($cari); ?> (<?php echo e($total); ?> Hasil)</h3>
    </div>
    </div>
    <div class="row mb-5">
...
<?php echo $__env->make('user.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tokoOnline\resources\views/user/cariproduk.blade.php ENDPATH**/ ?>