    ...
    <div class="container-scroller">
      ...
      <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
          <a class="navbar-brand brand-logo" href="<?php echo e(route('admin.dashboard')); ?>"><img src="<?php echo e(asset('adminassets')); ?>/assets/images/logo.png" alt="logo" /></a>
            ...
            <li class="nav-item nav-profile dropdown">
              <a class="nav-link dropdown-toggle" id="profileDropdown" href="#" data-toggle="dropdown" aria-expanded="false">
                <div class="nav-profile-img">
                  <img src="<?php echo e(asset('adminassets')); ?>/assets/images/faces-clipart/pic-1.png" alt="image">
            ...
            <li class="nav-item nav-profile">
              <a href="<?php echo e(route('admin.dashboard')); ?>" class="nav-link">
                <div class="nav-profile-image">
                  <img src="<?php echo e(asset('adminassets')); ?>/assets/images/faces-clipart/pic-1.png" alt="profile">
                  <span class="login-status online"></span>
                  <!--change to offline or busy as needed-->
                </div>
                <div class="nav-profile-text d-flex flex-column">
                  <span class="font-weight-bold mb-2">Ride Label</span>
...
</html><?php /**PATH C:\xampp\htdocs\tokoOnline\resources\views/admin/layout/app.blade.php ENDPATH**/ ?>